...
module.exports = {
	...
	async execute(interaction) {
        ...
        const collectClicks = initialResponse.createMessageComponentCollector({ filterClicks, time: 1200000 });

        // Listen for messages sent by the user of the command 
        const filterAnswers = (m) => m.author.id === interaction.author.id; 
        const collectAnswers = initialResponse.createMessageComponentCollector({ filterAnswers, time: 1200000 });
